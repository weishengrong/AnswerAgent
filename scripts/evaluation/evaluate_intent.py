...
用法：
  python -m scripts.evaluation.evaluate_intent
  python -m scripts.evaluation.evaluate_intent --test-file scripts/evaluation/data/intent_test_cases.json
  python -m scripts.evaluation.evaluate_intent --output scripts/evaluation/data/intent_results.json
"""
import asyncio
import json
import sys
...
if __name__ == "__main__":
    ...
    parser.add_argument("--test-file", default="scripts/evaluation/data/intent_test_cases.json", help="测试用例文件路径")
    parser.add_argument("--output", default=None, help="输出结果文件路径")
    args = parser.parse_args()

    output = args.output or f"scripts/evaluation/data/intent_results_{datetime.now().strftime('%Y%m%d_%H%M%S')}.json"
