...
用法：
  ...
  python -m scripts.evaluation.evaluate --test-file scripts/evaluation/data/test_cases.json
  python -m scripts.evaluation.evaluate --user-id test_user --output results.json
"""
import asyncio
import json
import sys
