...
用法：
  python -m scripts.evaluation.ab_test
  python -m scripts.evaluation.ab_test --test-file scripts/evaluation/data/test_cases.json
"""
import asyncio
import json
import sys
...
from scripts.evaluation.evaluate import run_evaluation, execute_sql_safely, compare_results
import logging
...
if __name__ == "__main__":
    ...
    parser.add_argument("--test-file", default="scripts/evaluation/data/test_cases.json", help="测试用例文件路径")
