...
用法：
  python -m scripts.evaluation.evaluate_react
  python -m scripts.evaluation.evaluate_react --only l2
  python -m scripts.evaluation.evaluate_react --only l3
  python -m scripts.evaluation.evaluate_react --output scripts/evaluation/data/react_results.json
...
async def main():
    ...
    if args.output is None:
        ...
        args.output = f"scripts/evaluation/data/react_results_{ts}.json"
